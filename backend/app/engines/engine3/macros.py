...
def compute_macros(
    ...
    *,
    ...
    # An `enhanced` training_status already covers the programming tweaks a
    # PCT user needs, and wrapping it in a separate toggle caused more
    # confusion than value. Accepted + ignored.
    ...
    * **peak**     — -700 kcal (contest-week depletion)
    ...
    _ = pct_mode_active  # V3.1: accepted-but-ignored for backwards compat
